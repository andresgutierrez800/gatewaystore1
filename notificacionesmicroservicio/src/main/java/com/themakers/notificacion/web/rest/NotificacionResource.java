...
import com.themakers.notificacion.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link com.themakers.notificacion.domain.Notificacion}.
 */
@RestController
@RequestMapping("/api")
