...
describe('FacturaDetalle e2e test', () => {
  ...
  it('should load FacturaDetalles', async () => {
    ...
    expect(await facturaDetalleComponentsPage.getTitle()).to.eq('gatewayFacturaApp.facturaDetalle.home.title');
    await browser.wait(
  ...
  it('should load create FacturaDetalle page', async () => {
    ...
    expect(await facturaDetalleUpdatePage.getPageTitle()).to.eq('gatewayFacturaApp.facturaDetalle.home.createOrEditLabel');
  ...
  it('should create and save FacturaDetalles', async () => {
    ...
    await promise.all([facturaDetalleUpdatePage.setProductoIdInput('5')]);
  ...
  it('should delete last FacturaDetalle', async () => {
    ...
    expect(await facturaDetalleDeleteDialog.getDialogTitle()).to.eq('gatewayFacturaApp.facturaDetalle.delete.question');
