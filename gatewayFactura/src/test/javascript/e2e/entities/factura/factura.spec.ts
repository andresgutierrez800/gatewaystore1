...
describe('Factura e2e test', () => {
  ...
  it('should load Facturas', async () => {
    ...
    expect(await facturaComponentsPage.getTitle()).to.eq('gatewayFacturaApp.factura.home.title');
  ...
  it('should load create Factura page', async () => {
    ...
    expect(await facturaUpdatePage.getPageTitle()).to.eq('gatewayFacturaApp.factura.home.createOrEditLabel');
  ...
  it('should delete last Factura', async () => {
    ...
    expect(await facturaDeleteDialog.getDialogTitle()).to.eq('gatewayFacturaApp.factura.delete.question');
