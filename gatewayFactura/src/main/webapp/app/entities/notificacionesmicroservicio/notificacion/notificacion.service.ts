...
export class NotificacionService {
  ...
  protected convertDateFromClient(notificacion: INotificacion): INotificacion {
    const copy: INotificacion = Object.assign({}, notificacion, {
      ...
      fechaEnviado: notificacion.fechaEnviado && notificacion.fechaEnviado.isValid() ? notificacion.fechaEnviado.toJSON() : undefined
    });
    return copy;
  }
  ...
  protected convertDateFromServer(res: EntityResponseType): EntityResponseType {
    if (res.body) {
      ...
      res.body.fechaEnviado = res.body.fechaEnviado ? moment(res.body.fechaEnviado) : undefined;
    }
    return res;
  }
  ...
  protected convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
    if (res.body) {
      res.body.forEach((notificacion: INotificacion) => {
        ...
        notificacion.fechaEnviado = notificacion.fechaEnviado ? moment(notificacion.fechaEnviado) : undefined;
      });
    }
    return res;
  }
